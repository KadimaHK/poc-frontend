...
class VwFeaturedOfferExclusive {
  /// Returns a new [VwFeaturedOfferExclusive] instance.
  VwFeaturedOfferExclusive({
    this.id,
    this.title,
    this.voucherCode,
    this.expiry,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VwFeaturedOfferExclusive &&
    other.id == id &&
    other.title == title &&
  ...
  /// Returns a new [VwFeaturedOfferExclusive] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static VwFeaturedOfferExclusive? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VwFeaturedOfferExclusive[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VwFeaturedOfferExclusive[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return VwFeaturedOfferExclusive(
  ...
  static List<VwFeaturedOfferExclusive> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <VwFeaturedOfferExclusive>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = VwFeaturedOfferExclusive.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, VwFeaturedOfferExclusive> mapFromJson(dynamic json) {
    final map = <String, VwFeaturedOfferExclusive>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = VwFeaturedOfferExclusive.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of VwFeaturedOfferExclusive-objects as value to a dart map
  static Map<String, List<VwFeaturedOfferExclusive>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<VwFeaturedOfferExclusive>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = VwFeaturedOfferExclusive.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
