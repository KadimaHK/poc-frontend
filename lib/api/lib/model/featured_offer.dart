...
class FeaturedOffer {
  ...
  @override
  String toString() => 'FeaturedOffer[id=$id, title=$title, voucherCode=$voucherCode, expiry=$expiry, details=$details, description=$description, redemptionPeriod=$redemptionPeriod, howToRedeem=$howToRedeem, isGlobal=$isGlobal, imageId=$imageId, establishmentId=$establishmentId]';
