    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "StoredLiqueurImage[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "StoredLiqueurImage[$key]" has a null value in JSON.');
        });
        return true;
      }());
