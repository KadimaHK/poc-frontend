...
class Featured {
  ...
  @override
  String toString() => 'Featured[id=$id, title=$title, description=$description, imageId=$imageId, content=$content, establishmentId=$establishmentId, createdAt=$createdAt, updatedAt=$updatedAt]';
