...
class Establishment {
  ...
  @override
  String toString() => 'Establishment[id=$id, name=$name, description=$description, location=$location, cordX=$cordX, cordY=$cordY, category=$category, thumbnail=$thumbnail, rank=$rank, bookingPoints=$bookingPoints, createdAt=$createdAt, updatedAt=$updatedAt]';
