...
class ReviewImageApi {
  ...
  /// * [String] prefer:
  ///   Preference
  Future<Response> reviewImageDeleteWithHttpInfo({ String? id, String? reviewId, String? imageUrl, String? prefer, }) async {
  ...
  /// * [String] prefer:
  ///   Preference
  Future<void> reviewImageDelete({ String? id, String? reviewId, String? imageUrl, String? prefer, }) async {
    final response = await reviewImageDeleteWithHttpInfo( id: id, reviewId: reviewId, imageUrl: imageUrl, prefer: prefer, );
  ...
  /// * [String] prefer:
  ///   Preference
  Future<Response> reviewImageGetWithHttpInfo({ String? id, String? reviewId, String? imageUrl, String? select, String? order, String? range, String? rangeUnit, String? offset, String? limit, String? prefer, }) async {
    // ignore: prefer_const_declarations
    final path = r'/review_image';
  ...
  Future<List<ReviewImage>?> reviewImageGet({ String? id, String? reviewId, String? imageUrl, String? select, String? order, String? range, String? rangeUnit, String? offset, String? limit, String? prefer, }) async {
    final response = await reviewImageGetWithHttpInfo( id: id, reviewId: reviewId, imageUrl: imageUrl, select: select, order: order, range: range, rangeUnit: rangeUnit, offset: offset, limit: limit, prefer: prefer, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  ...
  ///   review_image
  Future<Response> reviewImagePatchWithHttpInfo({ String? id, String? reviewId, String? imageUrl, String? prefer, ReviewImage? reviewImage, }) async {
    // ignore: prefer_const_declarations
    final path = r'/review_image';
  ...
  /// * [ReviewImage] reviewImage:
  ///   review_image
  Future<void> reviewImagePatch({ String? id, String? reviewId, String? imageUrl, String? prefer, ReviewImage? reviewImage, }) async {
    final response = await reviewImagePatchWithHttpInfo( id: id, reviewId: reviewId, imageUrl: imageUrl, prefer: prefer, reviewImage: reviewImage, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
