...
class RpcSignUpApi {
  ...
  /// * [String] prefer:
  ///   Preference
  Future<Response> rpcSignUpPostWithHttpInfo(RpcSignUpPostRequest args, { String? prefer, }) async {
    // ignore: prefer_const_declarations
    final path = r'/rpc/sign_up';
  ...
  /// * [String] prefer:
  ///   Preference
  Future<void> rpcSignUpPost(RpcSignUpPostRequest args, { String? prefer, }) async {
