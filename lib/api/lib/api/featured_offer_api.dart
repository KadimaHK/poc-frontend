...
class FeaturedOfferApi {
  ...
  /// * [String] prefer:
  ///   Preference
  Future<Response> featuredOfferDeleteWithHttpInfo({ String? id, String? title, String? voucherCode, String? expiry, String? details, String? description, String? redemptionPeriod, String? howToRedeem, String? isGlobal, String? imageId, String? establishmentId, String? prefer, }) async {
  ...
  /// * [String] prefer:
  ///   Preference
  Future<void> featuredOfferDelete({ String? id, String? title, String? voucherCode, String? expiry, String? details, String? description, String? redemptionPeriod, String? howToRedeem, String? isGlobal, String? imageId, String? establishmentId, String? prefer, }) async {
    final response = await featuredOfferDeleteWithHttpInfo( id: id, title: title, voucherCode: voucherCode, expiry: expiry, details: details, description: description, redemptionPeriod: redemptionPeriod, howToRedeem: howToRedeem, isGlobal: isGlobal, imageId: imageId, establishmentId: establishmentId, prefer: prefer, );
  ...
  Future<List<FeaturedOffer>?> featuredOfferGet({ String? id, String? title, String? voucherCode, String? expiry, String? details, String? description, String? redemptionPeriod, String? howToRedeem, String? isGlobal, String? imageId, String? establishmentId, String? select, String? order, String? range, String? rangeUnit, String? offset, String? limit, String? prefer, }) async {
    final response = await featuredOfferGetWithHttpInfo( id: id, title: title, voucherCode: voucherCode, expiry: expiry, details: details, description: description, redemptionPeriod: redemptionPeriod, howToRedeem: howToRedeem, isGlobal: isGlobal, imageId: imageId, establishmentId: establishmentId, select: select, order: order, range: range, rangeUnit: rangeUnit, offset: offset, limit: limit, prefer: prefer, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  ...
  ///   featured_offer
  Future<Response> featuredOfferPatchWithHttpInfo({ String? id, String? title, String? voucherCode, String? expiry, String? details, String? description, String? redemptionPeriod, String? howToRedeem, String? isGlobal, String? imageId, String? establishmentId, String? prefer, FeaturedOffer? featuredOffer, }) async {
    // ignore: prefer_const_declarations
    final path = r'/featured_offer';
  ...
  /// * [FeaturedOffer] featuredOffer:
  ///   featured_offer
  Future<void> featuredOfferPatch({ String? id, String? title, String? voucherCode, String? expiry, String? details, String? description, String? redemptionPeriod, String? howToRedeem, String? isGlobal, String? imageId, String? establishmentId, String? prefer, FeaturedOffer? featuredOffer, }) async {
    final response = await featuredOfferPatchWithHttpInfo( id: id, title: title, voucherCode: voucherCode, expiry: expiry, details: details, description: description, redemptionPeriod: redemptionPeriod, howToRedeem: howToRedeem, isGlobal: isGlobal, imageId: imageId, establishmentId: establishmentId, prefer: prefer, featuredOffer: featuredOffer, );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
  }
