...
part 'api/stored_liqueur_api.dart';
part 'api/stored_liqueur_image_api.dart';
part 'api/stored_liqueur_transfer_api.dart';
part 'api/user_api.dart';
part 'api/user_establishment_bookmark_api.dart';
...
part 'model/establishment_opening_hours.dart';
...
part 'model/stored_liqueur_transfer.dart';
part 'model/user.dart';
part 'model/user_establishment_bookmark.dart';
