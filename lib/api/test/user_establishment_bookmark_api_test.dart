...
/// tests for UserEstablishmentBookmarkApi
void main() {
  ...
  group('tests for UserEstablishmentBookmarkApi', () {
    ...
    //Future userEstablishmentBookmarkPost({ String select, String prefer, UserEstablishmentBookmark userEstablishmentBookmark }) async
    test('test userEstablishmentBookmarkPost', () async {
      // TODO
    });
