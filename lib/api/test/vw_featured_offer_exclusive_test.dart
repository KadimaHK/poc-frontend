...
// tests for VwFeaturedOfferExclusive
void main() {
  // final instance = VwFeaturedOfferExclusive();

  group('test VwFeaturedOfferExclusive', () {
    ...
    test('to test the property `redemptionPeriod`', () async {
      // TODO
    });

    // String howToRedeem
    test('to test the property `howToRedeem`', () async {
      // TODO
    });
