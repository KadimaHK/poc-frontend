...
// tests for StoredLiqueur
void main() {
  // final instance = StoredLiqueur();

  group('test StoredLiqueur', () {
    ...
    // String storedDate
    test('to test the property `storedDate`', () async {
      // TODO
    });
    ...
    // String updatedAt (default value: 'now()')
