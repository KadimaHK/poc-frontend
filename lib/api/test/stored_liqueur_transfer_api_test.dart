...
/// tests for StoredLiqueurTransferApi
void main() {
  ...
  group('tests for StoredLiqueurTransferApi', () {
    ...
    //Future storedLiqueurTransferPost({ String select, String prefer, StoredLiqueurTransfer storedLiqueurTransfer }) async
    test('test storedLiqueurTransferPost', () async {
      // TODO
    });
