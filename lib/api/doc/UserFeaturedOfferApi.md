...
> userFeaturedOfferDelete(userEmail, featuredOfferId, prefer)
...
try {
    api_instance.userFeaturedOfferDelete(userEmail, featuredOfferId, prefer);
} catch (e) {
...
> List<UserFeaturedOffer> userFeaturedOfferGet(userEmail, featuredOfferId, select, order, range, rangeUnit, offset, limit, prefer)
...
try {
    final result = api_instance.userFeaturedOfferGet(userEmail, featuredOfferId, select, order, range, rangeUnit, offset, limit, prefer);
    print(result);
} catch (e) {
...
> userFeaturedOfferPatch(userEmail, featuredOfferId, prefer, userFeaturedOffer)
...
try {
    api_instance.userFeaturedOfferPatch(userEmail, featuredOfferId, prefer, userFeaturedOffer);
} catch (e) {
