...
# **reviewImageDelete**
> reviewImageDelete(id, reviewId, imageId, prefer)
...
try {
    api_instance.reviewImageDelete(id, reviewId, imageId, prefer);
} catch (e) {
...
# **reviewImageGet**
> List<ReviewImage> reviewImageGet(id, reviewId, imageId, select, order, range, rangeUnit, offset, limit, prefer)
...
try {
    final result = api_instance.reviewImageGet(id, reviewId, imageId, select, order, range, rangeUnit, offset, limit, prefer);
    print(result);
} catch (e) {
...
# **reviewImagePatch**
> reviewImagePatch(id, reviewId, imageId, prefer, reviewImage)
...
try {
    api_instance.reviewImagePatch(id, reviewId, imageId, prefer, reviewImage);
} catch (e) {
