...
# **featuredDelete**
> featuredDelete(id, title, description, imageId, content, establishmentId, createdAt, updatedAt, prefer)
...
try {
    api_instance.featuredDelete(id, title, description, imageId, content, establishmentId, createdAt, updatedAt, prefer);
} catch (e) {
...
# **featuredGet**
> List<Featured> featuredGet(id, title, description, imageId, content, establishmentId, createdAt, updatedAt, select, order, range, rangeUnit, offset, limit, prefer)
...
try {
    final result = api_instance.featuredGet(id, title, description, imageId, content, establishmentId, createdAt, updatedAt, select, order, range, rangeUnit, offset, limit, prefer);
    print(result);
} catch (e) {
...
# **featuredPatch**
> featuredPatch(id, title, description, imageId, content, establishmentId, createdAt, updatedAt, prefer, featured)
...
try {
    api_instance.featuredPatch(id, title, description, imageId, content, establishmentId, createdAt, updatedAt, prefer, featured);
} catch (e) {
