...
> establishmentMenuImageDelete(establishmentMenuId, imageId, prefer)
...
try {
    api_instance.establishmentMenuImageDelete(establishmentMenuId, imageId, prefer);
} catch (e) {
...
> List<EstablishmentMenuImage> establishmentMenuImageGet(establishmentMenuId, imageId, select, order, range, rangeUnit, offset, limit, prefer)
...
try {
    final result = api_instance.establishmentMenuImageGet(establishmentMenuId, imageId, select, order, range, rangeUnit, offset, limit, prefer);
    print(result);
} catch (e) {
...
> establishmentMenuImagePatch(establishmentMenuId, imageId, prefer, establishmentMenuImage)
...
try {
    api_instance.establishmentMenuImagePatch(establishmentMenuId, imageId, prefer, establishmentMenuImage);
} catch (e) {
