...
> establishmentImageDelete(establishmentId, imageId, prefer)
...
try {
    api_instance.establishmentImageDelete(establishmentId, imageId, prefer);
} catch (e) {
...
> List<EstablishmentImage> establishmentImageGet(establishmentId, imageId, select, order, range, rangeUnit, offset, limit, prefer)
...
try {
    final result = api_instance.establishmentImageGet(establishmentId, imageId, select, order, range, rangeUnit, offset, limit, prefer);
    print(result);
} catch (e) {
...
> establishmentImagePatch(establishmentId, imageId, prefer, establishmentImage)
...
try {
    api_instance.establishmentImagePatch(establishmentId, imageId, prefer, establishmentImage);
} catch (e) {
