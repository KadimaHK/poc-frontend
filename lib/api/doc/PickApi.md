...
# **pickDelete**
> pickDelete(id, message, expiry, imageUrl, createdAt, updatedAt, prefer)
...
try {
    api_instance.pickDelete(id, message, expiry, imageUrl, createdAt, updatedAt, prefer);
} catch (e) {
...
# **pickGet**
> List<Pick> pickGet(id, message, expiry, imageUrl, createdAt, updatedAt, select, order, range, rangeUnit, offset, limit, prefer)
...
try {
    final result = api_instance.pickGet(id, message, expiry, imageUrl, createdAt, updatedAt, select, order, range, rangeUnit, offset, limit, prefer);
    print(result);
} catch (e) {
...
# **pickPatch**
> pickPatch(id, message, expiry, imageUrl, createdAt, updatedAt, prefer, pick)
...
try {
    api_instance.pickPatch(id, message, expiry, imageUrl, createdAt, updatedAt, prefer, pick);
} catch (e) {
